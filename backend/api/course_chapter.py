...
from db.models.all_models import Theme, Chat, Message, User
...
async def get_messages(id: int, current_user: Annotated[User, Depends(get_current_active_user)],
    ...
    return await service.messages(chat.id)
