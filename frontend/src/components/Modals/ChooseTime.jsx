    ...
    return (
        <Modal open={isModalOpen} onCancel={handleCancel} footer={[]} width={'100%'} bodyStyle={{height: '100%'}}>
            <div className={'h-full flex flex-col flex-wrap items-center justify-center'}>
                ...
                <p className={'text-lg text-center mt-5 mb-10'}>ВО СКОЛЬКО ВАМ БУДЕТ УДОБНО ПОЛУЧАТЬ<br/>ОБУЧАЮЩИЙ
                    МАТЕРИАЛ</p>
                <Form
                    ref={formRef}
                    className={"w-96"}
                ...
                >
                    ...
                    <Form.Item className={"mb-2"}>
                        <Button className={"big-button"} style={{width: "100%"}} type={"primary"} htmlType='submit'
                                loading={isLoading}>
