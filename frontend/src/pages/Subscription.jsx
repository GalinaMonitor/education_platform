...
const Subscription = () => {
  ...
  return (
    <div className={"h-full"}>
      <Link
        to={RouteNames.MAIN}
        className={"absolute flex flex-row items-center top-4 left-4"}
      >
      ...
      <div
        className={
          "flex flex-row justify-center items-center align-middle pl-60 pr-60 m-auto h-full"
        }
      >
        ...
        <Card
          ...
          className={"text-center p-10 content m-10"}
        >
