    ...
    return (
        <Modal open={isModalOpen} onCancel={handleCancel} footer={[]} width={'100%'} bodyStyle={{height: '100%'}}>
            <div className={'h-full flex flex-col flex-wrap items-center justify-center'}>
                ...
                <p className={'text-lg my-5'}>НА КАКОЙ ПЕРИОД ВРЕМЕНИ ВЫ ХОТИТЕ<br/>ПРИОБРЕСТИ ДОСТУП К ПЛАТФОРМЕ?</p>
                <Row justify={'space-around'} align={'middle'} className={'mb-5 w-screen items justify-center'}>
                    <Card style={{height: "fit-content"}} className={"text-center p-10 content m-5"}>
                ...
                <Link to={"/"}><p>БЕЗНАЛИЧНЫЙ РАСЧЁТ</p></Link>
