  ...
  return (
    <div>
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые ИП Перлин Петр
        Алексеевич (далее — Оператор). 1.1. Оператор ставит своей важнейшей
      ...
      <p>
        ...
        https://ku-store.ru/. 2.4. Информационная система персональных данных —
        ...
        определяемому Пользователю веб-сайта https://ku-store.ru/. 2.9.
        ...
        https://ku-store.ru/. 2.11. Предоставление персональных данных —
      ...
      <p>
        ...
        данные фамилия, имя, отчество электронный адрес номера телефонов год,
        месяц, дата и место рождения фотографии Правовые основания уставные
        (учредительные) документы Оператора Виды обработки персональных данных
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора admin@ku-pomogu.ru с
        ...
        Оператора admin@ku-pomogu.ru с пометкой «Отзыв согласия на обработку
      ...
      <p>
        ...
        Оператору с помощью электронной почты admin@ku-pomogu.ru. 12.2. В данном
        ...
        расположена в сети Интернет по адресу https://ku-store.ru/privacy.
      </p>
    </div>
  );
};
